...
public class WebView : MonoBehaviour
{
    ...
    private void Start()
    {
        _privacyPolicyPath = Constants.PRIVACY_URL;
        InitWebView();
    }

    public void InitWebView()
    {
        tittleText.text = PreferenceHelper.GetWebViewTittle();

        if (PreferenceHelper.GetWebViewTittle().Equals(Constants.PRIVACY_TITTLE))
        {
            Url = _privacyPolicyPath;
        }
        else
        {
            Url = licensePath;
    ...
    IEnumerator InitWebviewCoroutine()
    {
        ...
        // webViewObject.SetMargins(5, 350, 5, Screen.height / 200);
       // webViewObject.SetMargins(0, 310, 0, Screen.height / 5000);
